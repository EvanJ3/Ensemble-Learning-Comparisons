...
class RTLearner:
    ...
    def __init__(self,leaf_size=1,verbose=False): 
        self.x_data = None
        self.y_labels = None
        self.feature_criterion = self.random_split_feature
        self.split_criterion = self.random_split
    ...
    def random_split_feature(self,x,y):
        return randint(x.shape[1])
    
    def random_split(self,x,split_index):
        #Cutler
        #return (x[randint(x.shape[0]),split_index]+x[randint(x.shape[0]),split_index])/2
